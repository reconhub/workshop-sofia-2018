...
#!!! read in the file from data/copenhagen_stratified.csv using the functions
#    read.csv() and here::here() and place it in a variable called 'cph'
```
...
strata_risk <- function(var, case, strat) {
  #!!! Make a 3-way table with exposure of interest, the outcome and the 
  #    stratifying variable, in that order
  
  #!!! Use the epi.2by2 function to calculate RRs (by stating method = "cohort.count")
  
  #!!! combine the output from RR.crude.wald, RR.strata.wald, and RR.mh.wald
  
  #!!! add these rownames c("Crude", "Strata 1", "Strata 0", "Adjusted")
...
```{r, eval = FALSE}
#!!! List exposure variables (pasta, rocket, shrimps, ...)
#!!! Use lapply to run strata_risk for each one using veal as strata
```
