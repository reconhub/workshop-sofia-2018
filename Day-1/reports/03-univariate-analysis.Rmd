...
inspection and cleaning. Part 2 focussed on descriptive statistics. This 
practical will focus on univariable analysis. To identify (the) potential 
vehicle(s) in the outbreak, proceed with an analytical study where you use 
statistical tests to investigate the associations of some suspicious food items
with the disease.
...
The analysis continues with stratified analyses in part 4.
