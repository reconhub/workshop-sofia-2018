...
write.csv(cph, file = here::here("data", "copenhagen_descriptive.csv"), row.names = FALSE)
# read the file
cph2 <- read.csv(file = here::here("data", "copenhagen_descriptive.csv"), stringsAsFactors = FALSE)
identical(cph, cph2)

# save as a R data file
saveRDS(cph, file = here::here("data", "copenhagen_descriptive.rds"))
# read in the file
cph2 <- readRDS(file = here::here("data", "copenhagen_descriptive.rds"))
identical(cph, cph2)
```
